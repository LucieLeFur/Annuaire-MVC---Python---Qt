...
class Personne:
    ...
    def __init__(self, prenom : str, nom : str, 
        genre : g.Genre, 
        dateNaissance : datetime.date, dateMort : (Union[datetime.date,None]), 
        bio : str) -> None: 
        self.__prenom : str = prenom
        self.__nom : str = nom
        self.__genre : g.Genre = genre
        self.__naissance : datetime.date = dateNaissance
        self.__mort : (Union[datetime.date,None]) = dateMort
        self.__bio = bio
    ...
    def prenom(self, prenom :str) -> None: 
        self.__prenom = prenom[0].upper()+prenom[1:].lower()  
    ...
    @property
    def mort(self) -> (Union[datetime.date,None]) : return self.__mort
    @mort.setter
    ...
    # toJSON
    def toJSON(self) -> str:
        dictP: dict = self.toDictionnaire()
