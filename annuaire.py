...
class Annuaire:
    ...
    def save(self,jsonFile : str) -> None:
        ...
        with open(jsonFile, "w", encoding='utf-8') as file: 
            d : dict= {} 
            listPersonne : list= []
            for p in self.__listPersonne:
                listPersonne.append(p.toDictionnaire())
            d['annuaire'] = listPersonne
            json.dump(d,file,ensure_ascii=False)
        print(f'done!')

    def getPersonneByName(self, name: str) ->  (Union[personne.Personne,None]):
    ...
    def addPersonne(self, p : personne.Personne, index : Union[int,None] = None) -> None :
    ...
    def getPersonne(self) -> Union[personne.Personne, None] : 
        if self.__current != None: 
            return self.__listPersonne[self.__current]  
        else: 
            return None
...
if __name__ == "__main__" :
    ...
    annuaireJS : Annuaire = Annuaire('D:\\projet\\anphi.json')
    ...
    print("toto") if 1==2 else print("test")
